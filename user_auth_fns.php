...
echo "<div class='content'><b>You are not logged in. You must be logged in before you can use this site</b> <br></div>";
display_site_info();
...
$email = $row->email;
$from = "From: support@m3tech.com.ng \r\n";
$mesg = "Your M3Tech password has been changed to $password \r\n"."Please change it next time you log in. \r\n";
if (mail($email, 'M3Tech login information', $mesg, $from))
return true;
else
