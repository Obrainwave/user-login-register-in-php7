        ...
        <div class="container">
            ...
            <header>
				...
				<nav class="codrops-demos">
					<span>Click <strong>"Sign Up"</strong> on the Login Page to register your login details into the database</span>
...
{
	echo "<div class='content'><h3>This is M3 Technology(M3Tech)'s Registration and Login source code.</h3>
	<p>Thanks for downloading my simple work. I'm <a href='https://facebook.com/olaiwola.akeem.3'><b>Olaiwola Akeem</b></a>. 
	 ...
	 code or you want more functionalities of this source code. You can also contact me if you have any big project 
	  you want me to handle for you. Open the README file to learn how to use this source code.</p>
	</div><br>";
	echo "<div class='cotent'><p>Visit our website for more of our works</p><p><a href='https://m3tech.com.ng' >https://m3tech.com.ng</a></p></div><br><br>";
}
...
{
	echo "<a href='login.php'> <b>Login or Sign Up here</b></a> ";
}
...
?>
	<footer>
	&copy <?php echo date('Y'); ?> <a href='https://m3tech.com.ng'> M3 Techlonogy</a> &nbsp;&nbsp; | &nbsp;&nbsp; Designed by <a href="https://facebook.com/olaiwola.akeem.3" target="blank">
